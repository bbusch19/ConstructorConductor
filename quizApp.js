...
//Let's say three people signed up for our service, create 3 instances of User and add each to the users Array
  ...
  var geoff = new QuizUser('Geoff', 'gerf@gmail.com', 'mypassword', 100);
  var kory = new QuizUser('Kory', 'kory@gmail.com', 'mypassword', 75);
  var austin = new QuizUser('Austin', 'steeze@gmail.com', 'mypassword', 50);

  quizUsers.push(geoff);
  quizUsers.push(kory);
  quizUsers.push(austin);
